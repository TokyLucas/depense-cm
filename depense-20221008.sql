...
CREATE INDEX fk_personnel_chargesocial_charges_social_0 ON rh_cm_local.personnel_chargesocial ( chargesocial_id );

CREATE INDEX fk_personnel_chargesocial_personnel_0 ON rh_cm_local.personnel_chargesocial ( personnel_id );
